...
namespace AuditLogService.Core.Migrations
{
    ...
    [Migration("20231213130424_MemberWarning")]
    partial class MemberWarning
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AuditLogService.Core.Entity.ApiRequest", b =>
                {
                    ...
                    b.HasIndex("Method", "TemplatePath", "IsSuccess");
            ...
            modelBuilder.Entity("AuditLogService.Core.Entity.MemberWarning", b =>
                {
                    b.HasOne("AuditLogService.Core.Entity.LogItem", "LogItem")
                        .WithOne("MemberWarning")
                        .HasForeignKey("AuditLogService.Core.Entity.MemberWarning", "LogItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
